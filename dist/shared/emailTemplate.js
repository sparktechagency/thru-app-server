...
const verification_interface_1 = require("../app/modules/verification/verification.interface");
...
const resendOtp = (values) => {
    const isReset = values.type === verification_interface_1.VERIFICATION_TYPE.RESET_PASSWORD;
    const data = {
        to: values.email,
